...
public class HoaDonChiTietDAO extends QLBNDAO<HoaDonChiTiet, String> {
    ...
    final String SELECT_MaHDCT_BY_MHD_MSP = "select hdct.MaHDCT, hdct.SoLuong, hdct.MaHD, hdct.MaSP from HoaDon hd inner join HoaDonChiTiet hdct on hd.MaHD = hdct.MaHDCT where hdct.MaHD = ? and hdct.MaSP = ?";
